...
async function createPublishTables() {
  try {
    console.log('🔄 Creating published_content table...');
    ...
    console.log('🔄 Creating content_backups table...');
    ...
    console.log('🔄 Creating publish_history table...');
    ...
    await query('CREATE INDEX IF NOT EXISTS idx_backups_page_created ON content_backups(page_name, created_at DESC)');
    await query('CREATE INDEX IF NOT EXISTS idx_history_page_created ON publish_history(page_name, created_at DESC)');
